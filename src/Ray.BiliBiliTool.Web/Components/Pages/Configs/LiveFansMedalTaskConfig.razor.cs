...
public partial class LiveFansMedalTaskConfig : ComponentBase
{
    [Inject]
    ...
    private LiveFansMedalTaskOptions _config = new();
    ...
    private Task LoadConfigAsync()
    {
        ...
        try
        {
            _config = LiveFansMedalTaskOptionsMonitor.CurrentValue;
        }
        catch (Exception ex)
        {
