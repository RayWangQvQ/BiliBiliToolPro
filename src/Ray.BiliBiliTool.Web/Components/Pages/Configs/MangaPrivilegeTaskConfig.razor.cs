...
public partial class MangaPrivilegeTaskConfig : ComponentBase
{
    [Inject]
    ...
    private MangaPrivilegeTaskOptions _config = new();
    ...
    private Task LoadConfigAsync()
    {
        ...
        try
        {
            _config = MangaPrivilegeTaskOptionsMonitor.CurrentValue;
        }
        catch (Exception ex)
        {
