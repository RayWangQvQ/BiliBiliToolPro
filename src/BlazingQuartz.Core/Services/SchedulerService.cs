...
namespace BlazingQuartz.Core.Services
{
    public class SchedulerService : ISchedulerService
    {
        ...
        public async Task<TriggerDetailModel?> GetTriggerDetail(
            string triggerName,
            string triggerGroup
        )
        {
            ...
            switch (triggerType)
            {
                ...
                case TriggerType.Daily:
                    ...
                    model.TriggerIntervalUnit =
                        daily.RepeatIntervalUnit.ToBlazingQuartzIntervalUnit();
            ...
            switch (triggerDetailModel.TriggerType)
            {
                ...
                case TriggerType.Daily:
                    tbldr = tbldr.WithDailyTimeIntervalSchedule(x =>
                    {
                        ...
                        {
                            x.StartingDailyAt(
                                triggerDetailModel.StartDailyTime.Value.ToTimeOfDay()
                            );
                        }
