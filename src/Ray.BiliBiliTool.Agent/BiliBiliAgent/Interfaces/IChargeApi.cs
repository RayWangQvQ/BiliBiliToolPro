...
namespace Ray.BiliBiliTool.Agent.BiliBiliAgent.Interfaces
{
    ...
    public interface IChargeApi : IBiliBiliApi
    {
        ...
        /// <returns></returns>
        [HttpPost("/x/ugcpay/web/v2/trade/elec/pay/quick?is_bp_remains_prior=true&bp_num={bp_num}&up_mid={up_mid}&otype=up&oid={oid}&csrf={csrf}")]
        ...
        /// <param name="csrf"></param>
        /// <returns></returns>
        [HttpPost("/x/ugcpay/trade/elec/message?order_id={order_id}&message={message}&csrf={csrf}")]
